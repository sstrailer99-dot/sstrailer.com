...
export function CtaBanner() {
  return (
    <section className="relative overflow-hidden bg-navy py-12 sm:py-16 md:py-20">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 px-4 sm:gap-8 sm:px-5 md:flex-row md:items-center md:px-8">
        <div className="reveal">
          <p className="text-xs font-bold uppercase tracking-[0.25em] text-accent-hot">
            Ready to build?
          </p>
          <h2 className="display mt-2 text-3xl font-extrabold text-white sm:text-4xl md:text-5xl">
